...
class FilterPrunner:
    """Class FilterPrunner performs structured pruning on filters based on the first 
    order Taylor expansion of the network cost function from Nvidia:
    ...
    def forward(self, x):
        ...
        # Onet
        if hasattr(self.model, 'conv6_1') and hasattr(self.model, 'conv6_2') \
                and hasattr(self.model, 'conv6_3'):
