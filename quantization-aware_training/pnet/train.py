...
from nets.quant_mtcnn import PNet
...
model.load_state_dict(torch.load('pretrained_weights/quant_mtcnn/best_pnet.pth'), strict=True)
...
# Set trainer
trainer = PNetTrainer(config.EPOCHS, dataloaders, model, optimizer, scheduler, device)
